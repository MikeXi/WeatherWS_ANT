...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/testResults">
        ...
        <head>
            ...
            <script type="text/javascript"><![CDATA[
				...
				function checkfailure() {
					if (document.getElementById("bt").innerHTML == "View Failures") {
						document.getElementById("bt").innerHTML = "View All";
					...
					}else if(document.getElementById("bt").innerHTML == "View All") {
						document.getElementById("bt").innerHTML = "View Failures";
						var trs = document.getElementsByTagName("table")[1].getElementsByTagName('tr');
						for( var i = 1; i < trs.length; i++ ) {
							var tr = trs[i];
							if( "Failure" != tr.className )
        ...
        <body>
			...
			<button class="button" id="bt" onclick="checkfailure()" style="float:right">View Failures</button>
			<h2>Pages</h2>
			<table align="center" class="details" cellpadding="5" cellspacing="2" width="100%">
				<tr valign="top">
					<th width="30%">URL</th>
